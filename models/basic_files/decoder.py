...
def dynamic_distraction_decoder(config,
  ...
  with variable_scope.variable_scope(
    ...
    #distract_state  = distract_initial_state
    ...
    batch_attn_size_state = array_ops.stack([batch_size, attn_size_state])
    batch_attn_size_query = array_ops.stack([batch_size, attn_size_query])
